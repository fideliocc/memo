...
import { deletePost, addLikeSingle, addFavoriteSingle } from '../../actions/postActions';
...
class PostItem extends Component {
  ...
  onFavClick(id) {
    if(this.props.auth.isAuthenticated) {
      this.props.addFavoriteSingle(id);
      } else {
        this.onOpenModal();
      }
  }
  ...
  render() {
    ...
    return (
      <div className="card card-body mb-3">
        ...
        >
          <h2>Laméntate, para pasarlo mejor</h2>
          <hr></hr>
...
PostItem.propTypes = {
  ...
  addFavoriteSingle: PropTypes.func.isRequired, 
...
export default connect(mapStateToProps, { deletePost, addLikeSingle, addFavoriteSingle })(
  PostItem
);
